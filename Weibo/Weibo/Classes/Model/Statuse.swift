...
class Statuse : NSObject, NSCoding{
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		if let annotationsArray = dictionary["annotations"] as? [[String:Any]]{
			for dic in annotationsArray{
				let value = Annotation(fromDictionary: dic)
				annotations.append(value)
			}
		}
		attitudesCount = dictionary["attitudes_count"] as? Int
		bizFeature = dictionary["biz_feature"] as? Int
		bizIds = dictionary["biz_ids"] as? [Int]
		...
		if let extendInfoData = dictionary["extend_info"] as? [String:Any]{
			extendInfo = ExtendInfo(fromDictionary: extendInfoData)
		}
		...
		picStatus = dictionary["picStatus"] as? String
		picUrls = dictionary["pic_urls"] as? [AnyObject]
		positiveRecomFlag = dictionary["positive_recom_flag"] as? Int
		repostsCount = dictionary["reposts_count"] as? Int
		if let retweetedStatusData = dictionary["retweeted_status"] as? [String:Any]{
			retweetedStatus = RetweetedStatu(fromDictionary: retweetedStatusData)
		}
	...
	func toDictionary() -> [String:Any]
	{
		...
		if annotations != nil{
			...
			for annotationsElement in annotations {
				dictionaryElements.append(annotationsElement.toDictionary())
			}
			dictionary["annotations"] = dictionaryElements
		}
		...
		if extendInfo != nil{
			dictionary["extend_info"] = extendInfo.toDictionary()
		}
		if favorited != nil{
		...
		if picStatus != nil{
			dictionary["picStatus"] = picStatus
		}
		if picUrls != nil{
			dictionary["pic_urls"] = picUrls
		}
		...
		if retweetedStatus != nil{
			dictionary["retweeted_status"] = retweetedStatus.toDictionary()
		}
		if rid != nil{
			dictionary["rid"] = rid
		}
    ...
    */
	...
	{
         annotations = aDecoder.decodeObject(forKey :"annotations") as? [Annotation]
         ...
         bizIds = aDecoder.decodeObject(forKey: "biz_ids") as? [Int]
         ...
         extendInfo = aDecoder.decodeObject(forKey: "extend_info") as? ExtendInfo
         ...
         picStatus = aDecoder.decodeObject(forKey: "picStatus") as? String
         picUrls = aDecoder.decodeObject(forKey: "pic_urls") as? [AnyObject]
         ...
         rid = aDecoder.decodeObject(forKey: "rid") as? String
    ...
    */
    @objc func encode(with aCoder: NSCoder)
	{
		...
		if bizIds != nil{
			aCoder.encode(bizIds, forKey: "biz_ids")
		}
		if bmiddlePic != nil{
		...
		if extendInfo != nil{
			aCoder.encode(extendInfo, forKey: "extend_info")
		}
		if favorited != nil{
		...
		if picStatus != nil{
			aCoder.encode(picStatus, forKey: "picStatus")
		}
		if picUrls != nil{
